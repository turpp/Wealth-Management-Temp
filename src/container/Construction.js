...
export default class Construction extends React.Component{
    ...
    render(){
        return<div>
            {/* <h1>Welcome to Wealth Management of the Ozarks</h1> */}
            <Navbar>
            <Navbar.Brand>
                {/* <Image  roundedCircle src={WMOLogoWhite} alt="logo" className='nav-banner-logo' /> */}
            ...
            <Container fluid>
                ...
                <Row className="justify-content-md-center">
                    ...
                    <div className='address'>
                        <div className='steet-address'>1200 West Commercial St</div>
                        <div className='city'>Ozark, Ar 72949</div>
                    </div>
                    <div className='phone'>
                        <strong>Phone:</strong>
                        <p>(479)-209-0167</p>
...
<hr></hr>
                        <p>Our website is currently under construction and will be an informational resource designed to help you learn more about personal wealth. Wealth Management of the Ozarks will help you understand the opportunities that become available when you take a proactive approach to your personal financial situation. You will find a variety of articles, calculators, and research reports that we hope will answer your questions or stimulate your interest.
                        </p>
                        ...
                        <p>In the mean time,  We are open for business and would love to assist any way possible. If you have any further questions, please call us <strong>(479) 209-0167</strong>(Cell) <strong>(479)-401-2525</strong>(Office) or e-mail us <a href="mailto:T.F.White@lpl.com" target='_top'>T.F.White@lpl.com</a>. We will be happy to help and look forward to talking with you.</p>
                           ...
                           {/* The main webiste is under construction, I am open for business and would love to spend some time getting to know you better. My new website will have numerous great resources to help you become financialy independent. Please check back later to learn more. In the mean time, please contact me at <strong>(479)-209-0167</strong> and/or <strong>T.F.White@lpl.com</strong> */}
                        </Card.Text>
                </Card.Body>
                </Card>
